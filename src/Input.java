...
public class Input {
    ...
    void update_message() {
        ...
        String format = _current_ship_deck > 1 ? "(you must specify the coordinates of the starting and ending points)" : "(x,y)";
    ...
    public void process(GameState state) {
        ...
        boolean quit_game = "q".equals(in) || "выход".equals(in);
