...
public class Map {
    ...
    public Map() {
        ...
        _head = new char[]{'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K', 'L', 'M', 'N', 'O', 'P'};
    ...
    public void add_object(Deck object) {

        Point position = object.get_position();

        if (is_valid_coord(position)) {

            _objects[position.y][position.x] = (IMapObject) object;
        } else {

            log.warning("Не могу добавить объект карты");
        }
    }
